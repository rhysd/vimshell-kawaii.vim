...
" Default settings
let g:vimshell_kawaii_prompt_normal       = get(g:, 'vimshell_kawaii_normal', "('w'U)..")
let g:vimshell_kawaii_prompt_happy        = get(g:, 'vimshell_kawaii_happy',  "(^w^U)))")
let g:vimshell_kawaii_prompt_sad          = get(g:, 'vimshell_kawaii_sad',    "(((U;_;)")
